...
ASIC_API_TIMEOUT = int(os.getenv("ASIC_API_TIMEOUT", "10"))  # seconds per ASIC API call
ASIC_API_RETRIES = int(os.getenv("ASIC_API_RETRIES", "2"))  # retry attempts on failure
